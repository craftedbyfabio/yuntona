...
LLM orchestration framework for building AI agents and chains. Core infrastructure every security team must understand.

## What It Does

The dominant LLM orchestration framework for building AI agents and chains. Provides abstractions for connecting LLMs to tools, data sources, memory, and other components. Core infrastructure that a huge portion of AI applications are built on.
